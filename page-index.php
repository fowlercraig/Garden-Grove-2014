...
?>
  ...
  <div id="section_home" class="section">
    <div class="frame wide">
      ...
      <div class="bit-4 side right text-center color-towergreen"><p>Join the fun<span class="thehand">OCT 12, 2014</span>11am-4pm</p></div>
    </div>
  ...
  <div id="section_content" class="section">
    <div class="frame">
      ...
      <div class="bit-1"><div class="item" id="block-route">
          <div class="bit-4 skybluedark"><a class="meta" href="/about/about-reimagine-garden-grove/">The Route<span>Learn More</span></a></div>
      ...
      <div class="bit-2"><div class="item" id="block-events" style="background-image: url(<?php echo $medium_events; ?>);">
        <a class="meta" href="/events-schedule-map/">EVENT SCHEDULE/MAP<span>Learn More</span></a>
